...
\begin{enumerate}
	...
	\item Fitur deteksi gerakan (motion detection), deteksi penyusup (intruder detection), monitoring telemetri perangkat komprehensif, pembaruan firmware OTA, dan pengiriman notifikasi mobile berhasil diintegrasikan pada sistem. Fitur deteksi gerakan mampu mendeteksi pergerakan pada area pengawasan untuk memicu penyimpanan citra dan push notification secara real-time, sedangkan data telemetri mempermudah pemeliharaan operasional perangkat secara berkala.
