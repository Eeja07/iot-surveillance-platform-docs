...
Motion detection dirancang untuk berjalan langsung secara lokal pada perangkat keras ESP32-CAM (sisi edge) guna mendeteksi perubahan kondisi pada area pengamatan sebelum data citra dikirimkan ke server. Metode ini bekerja dengan membandingkan frame yang diperoleh kamera terhadap frame sebelumnya. Apabila perubahan yang terdeteksi melebihi nilai ambang batas yang telah ditentukan, sistem akan menganggap terdapat aktivitas pada area pengawasan dan memicu proses pengambilan serta pengiriman data gambar.
