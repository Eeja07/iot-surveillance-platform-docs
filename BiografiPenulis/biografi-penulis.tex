...
Pada penelitian tugas akhir ini, penulis memilih untuk mengembangkan dan mengoptimalkan platform pemantauan CCTV berbasis IoT (MIOTVision) yang berfokus pada stabilisasi komunikasi data, deteksi gerakan, pemantauan telemetri perangkat, serta efisiensi infrastruktur server. Penulis berharap hasil penelitian ini dapat menjadi kontribusi nyata terhadap pengembangan sistem pengawasan keamanan berbasis teknologi IoT di Indonesia. Bagi pembaca yang memiliki kritik, saran, atau pertanyaan mengenai tugas akhir ini dapat menghubungi penulis melalui surel mahijapradipta86@gmail.com.
